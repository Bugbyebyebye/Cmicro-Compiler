...
var Builtins = []struct {
		...
		&Builtin{Fn: func(args ...Object) Object {
			...
			if args[0].Type() != ARRAY_OBJ {
				return newError("argument to %q must be %s, got %s",
					BuiltinFuncNameFirst, ARRAY_OBJ, args[0].Type())
			}
	...
	},
	{
		...
		&Builtin{Fn: func(args ...Object) Object {
			...
			if args[0].Type() != ARRAY_OBJ {
				return newError("argument to %q must be %s, got %s",
					BuiltinFuncNameLast, ARRAY_OBJ, args[0].Type())
			}
	...
	},
	{
		...
		&Builtin{Fn: func(args ...Object) Object {
			...
			if args[0].Type() != ARRAY_OBJ {
				return newError("argument to %q must be %s, got %s",
					BuiltinFuncNameRest, ARRAY_OBJ, args[0].Type())
			}
	...
	},
	{
		...
		&Builtin{Fn: func(args ...Object) Object {
			...
			if args[0].Type() != ARRAY_OBJ {
				return newError("argument to %q must be %s, got %s",
					BuiltinFuncNamePush, ARRAY_OBJ, args[0].Type())
			}
